...
int main(int argc, char** argv) {
	...
	// ros::Subscriber acc_1_y_sub = nh.subscribe("/arduino_1_2/acc1_y", 1, acc1YCallback);
	...
	while (angular_vel_z == 0.0){
		ls_position == 0.0 || le_position == 0.0 || ps_theta == 0.0 || 
	...
	rw_xx << 0.0152280633251176, -0.0045052508407, -0.0124737791199814, 0.0132361020402673, 0.0396103014132292, 0.0136544962607276;
	rw_x = 500 * rw_xx;
	...
	while (!g_request_shutdown) {
		...
		// thrust_vector.vector.x = 0.1;
		// thrust_vector.vector.y = 0.1;
