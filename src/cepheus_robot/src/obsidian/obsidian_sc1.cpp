...
double acc1_x = 0.0, acc1_y = 0.0, acc1_z = 0.0, acc2_x = 0.0, acc2_z = 0.0, acc3_x = 0.0, acc3_z = 0.0;
double acc2_y = 0.0, acc2_y_offset = 0.0, acc3_y = 0.0, acc3_y_offset = 0.0, acc2_y_sum = 0.0, acc3_y_sum = 0.0;
double acc1_x_sum = 0.0, acc1_y_sum = 0.0, acc1_z_sum = 0.0, acc2_x_sum = 0.0, acc2_z_sum = 0.0, acc3_x_sum = 0.0, acc3_z_sum = 0.0;
double acc1_x_offset = 0.0, acc1_y_offset = 0.0, acc1_z_offset = 0.0, acc2_x_offset = 0.0, acc2_z_offset = 0.0, acc3_x_offset = 0.0, acc3_z_offset = 0.0;
...
int main(int argc, char** argv) {
    ...
    // ros::Publisher acc1_y_pub = nh.advertise<std_msgs::Float64>("acc1_y", 1);
	...
	double t = 0.0, time = 0.0, move_time = 0.0, tminus = 0.0, tf = 0.0;
	...
	while (ps_theta == 0.0 || angular_vel_z == 0.0 || ps_x == 0.0 || ps_y == 0.0 || acc_x == 0 || acc_y == 0 || acc1_x == 0 || acc1_z == 0 || acc2_x == 0 || acc2_z == 0 || acc3_x == 0 || acc3_z == 0) {
		cout << "ps_theta " << ps_theta << " angular_vel_z " << angular_vel_z << "ps_x " << ps_x << " ps_y " << ps_y << endl;
		cout << "acc_x " << acc_x << " acc_y " << acc_y << endl;
		cout << "acc1_x " << acc1_x << " acc1_z " << acc1_z << "acc2_x " << acc2_x << " acc2_z " << acc2_z << "acc3_x " << acc3_x << " acc3_z " << acc3_z << endl;
...
for (int i=0; i < 100; i++) {
	...
	while (!g_request_shutdown) {
        ...
        // cout << "acc1_x: " << acc1_x << endl;
        // cout << "acc1_z: " << acc1_z << endl;
        // cout << "acc2_x: " << acc2_x << endl;
        // cout << "acc2_z: " << acc2_z << endl;
        // cout << "acc3_x: " << acc3_x << endl;
        // cout << "acc3_z: " << acc3_z << endl;
